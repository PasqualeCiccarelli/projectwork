...
public class BoxEntity extends ProdottoEntity {
	...
	public BoxEntity(Long id, String nome, String descrizione, Categoria categoria, Brand brand, boolean disponibilita,
			String immagine, double prezzo, double prezzoScontato, Tipo tipo, LocalDate dataInizio, int rimanenza,
			int numero_carte, int numero_bustine, AdminEntity admin, List<DettaglioOrdineEntity> dettagliOrdine) {
		this.id = id;
		this.nome = nome;
		...
		this.numero_bustine = numero_bustine;
		this.admin = admin;
	...
	public int getNumero_bustine() {
		return numero_bustine;
	}

	public void setNumero_bustine(int numero_bustine) {
		this.numero_bustine = numero_bustine;
	}
