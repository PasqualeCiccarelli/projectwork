...
public class BustinaDto {
    ...
    public static BustinaDto fromEntity(BustinaEntity entity) {
        if (entity == null) return null;

        BustinaDto dto = new BustinaDto();
    ...
    public BustinaEntity toEntity(BustinaEntity existingEntity) {
        BustinaEntity entity = (existingEntity != null && this.getId() != null) ? existingEntity : new BustinaEntity();
