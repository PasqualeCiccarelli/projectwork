                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="product" style="position: relative;">
                            ...
                            <a href="/DettagiProdotto.html?id=${prodotto.id}">
                                <img src="img/magic/${prodotto.immagine}" alt="${prodotto.nome}" ${imgStyle}>
                            </a>
                            <h3 class="h5" style="color: white;">${prodotto.nome}</h3>
                            <p style="color: white;">${prodotto.descrizione}</p>
