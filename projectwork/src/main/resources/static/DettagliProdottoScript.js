  ...
  try {
    ...
    dettagliCartaDiv.innerHTML = `
        <div class="prodotto-container row">
            <div class="immagine-container col-12 col-lg-8">
                <img src="img/magic/${prodotto.immagine}" 
                     alt="${prodotto.nome}" 
                     class="${
                       isCard(prodotto) ? "card-effect" : "zoom-effect"
                     }">
            </div>

            <div class="info-container col-12 col-lg-4">
                ...
                <p><strong>Dettagli Specifici:</strong> ${
                  prodotto.specificDetails || "Non disponibile"
                }</p>
                    ...
                    ${
                      prodotto.categoria === "SPECIALE"
                        ...
                        <p style="color: #e53935; font-size: 1.3em; margin: 10px 0;">
                            <strong>Prezzo scontato: €${prodotto.prezzoScontato.toFixed(
                              2
                            )}</strong>
                        </p>
                    `
                        ...
                        <p style="font-size: 1.3em; margin: 10px 0;">
                            <strong>Prezzo: €${prodotto.prezzo.toFixed(
                              2
                            )}</strong>
                        </p>
                    `
